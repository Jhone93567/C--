...
int main()
{
    ...
    int ans = 1;   // resposta do usuario sobre querer ver outro filme
    int i = 0;         // contador
    ...
    while (ans == 1) // while para repetir o codigo enquanto o usuario quiser assistir algum filme
    {
        ...
        while(rgen != 1 && rgen != 2 && rgen != 3 && rgen != 4 && rgen != 5 && rgen != 6 && rgen != 7 && rgen != 8 && rgen != 9)
		{
			cout << "Qual genero voce quer ver?" << endl;
        ...
        case 5:
            ...
            for (int n = 0; n < 5; n++)
            {
				...
				if(rand[n] == rand[n+1])
                	...
                	cout << "Infelizmente ainda nao temos filmes desse genero disponiveis para voce ;(" << endl;
				else    
			        cout << filme[rand[n]].nomef << endl;
            }
